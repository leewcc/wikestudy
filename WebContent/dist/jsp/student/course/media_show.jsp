...
<% }%>
	...
	<%-- 	<object type="application/x-shockwave-flash">
		...
		<div class="video" id="HLSPlayer" style="height: 600px;">
				<div id="my" style="height: 600px;">
			        <script id="your_player">
			            var vID = "";
			            var vWidth = "100%";
			            var vHeight = "100%";
	...
	// 		            var  vHLSurl = "http://ocs3p05j9.bkt.clouddn.com/327abb1de62-67d7-45fc-ab93-84f492e4f1e3.m3u8";
			        </script>
	...
	$(document).ready(function(){
 	...
 	var putData = function () {
 	   ...
 	   if (!flag) {
 		...
 		$.ajax({
			type:"POST",
			url:"/wikestudy/dist/jsp/student/course/cou_omment_put?secId="+secId,
			...
			if(td[i].name == "secName") {
				...
				if(!(td[i].value==""||td[i].value==null)) {
					  ...
					  var s = "<script>"
			                ...
			                + "var vPlayer = '/wikestudy/dist/tools/HLSPlayer.swf?v=1.5';"
			                + "var vHLSset= '/wikestudy/dist/tools/HLS.swf';"
			                + "var vPic = '/wikestudy/dist/images/start.jpg';"
			                + "var vCssurl = '/wikestudy/dist/images/mini.css';"
			                + "var vHLSurl = 'http://" + td[i].value+"'";
			                + "<\/script>";
						root.append(s);
						 root.append('<script type="text/javascript" src="/wikestudy/dist/js/hls.min.js" ><\/script>');
				}
